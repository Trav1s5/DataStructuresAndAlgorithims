# Dijkstra Algorithm Implementation. and Shortest Path First Implementation.
import heapq
import heapq
...
class Graphs:
    ...
    def shortest_path_first(self, start_node):
        """
        An alias for the Dijkstra method, as Dijkstra's is the canonical
        "Shortest Path First" (SPF) algorithm for graphs with non-negative edge weights.
        """
...
if __name__ == '__main__':
    ...
    print("Shortest path first from A:\n")
    print(graph_obj.shortest_path_first("A"))
